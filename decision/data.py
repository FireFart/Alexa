...
WELCOME_MESSAGE = _("Welcome to decision maker. Please ask your question.")
WELCOME_RETRY = _("Please ask your question.")
COPYRIGHT = _("copyright by firefart")
HELP_MESSAGE = _("Please ask a policy related question like is it allowed to disabled windows updates?")
